...
import { Trophy, Check, X, Minus, Target, ArrowRight, RotateCcw, Search } from "lucide-react";
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mt-8">
        <Link to={`/app/incele/${r.test_id}/${r.session_id}`} state={{ result: r, sessionId: r.session_id }} data-testid="result-review" className="flex-1 flex items-center justify-center gap-2 bg-subject-fen text-white font-semibold py-3 rounded-xl hover:opacity-90 transition-opacity">
          <Search size={16} /> Soruları incele
        </Link>
      ...
      <Link to="/app/denemeler" data-testid="result-again" className="mt-3 flex items-center justify-center gap-2 border border-zinc-300 font-semibold py-3 rounded-xl hover:border-ink transition-colors">
